...
import com.example.model.VisitorExample.Criteria;
import com.example.model.VisitorExample.Criterion;
...
public class VisitorSqlProvider {
    ...
    protected void applyWhere(SQL sql, VisitorExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
