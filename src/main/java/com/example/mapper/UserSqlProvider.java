...
import com.example.model.UserExample.Criteria;
import com.example.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getInfoNum() != null) {
            VALUES("info_num", "#{infoNum,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getInfoNum() != null) {
            SET("info_num = #{record.infoNum,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getInfoNum() != null) {
            SET("info_num = #{infoNum,jdbcType=INTEGER}");
        }
