...
import com.example.model.ShopExample.Criteria;
import com.example.model.ShopExample.Criterion;
...
public class ShopSqlProvider {
    ...
    public String selectByExampleWithBLOBs(ShopExample example) {
        SQL sql = new SQL();
